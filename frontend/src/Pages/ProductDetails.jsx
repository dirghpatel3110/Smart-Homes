...
//   const [likeCount, setLikeCount] = useState(null);  // New state for like count
...
//         const response = await axios.get(`http://localhost:8080/myservlet/products?action=getLike&productId=${product.id}`);
//         console.log(response);
//         const likeData = response.data.likeCount;
//         if (likeData != null && !isNaN(likeData)) {
//           setLikeCount(likeData);
//         } else {
//           setLikeCount("NaN");  // Handle invalid like count
//         }
//       } catch (error) {
//         console.error("Error fetching like count:", error);
//         setLikeCount("NaN");  // Handle fetch error
//       }
//     };
...
//         let total = (product.price - product.retailer_special_discounts - product.manufacturer_rebate) * quantity + accessoriesTotal;

//         if (isChecked && product.warranty_price) {
//           total += parseFloat(product.warranty_price);
//         }
//         const discount = (product.retailer_special_discounts + product.manufacturer_rebate) * quantity;
...
//     try {
//       await axios.post(`http://localhost:8080/myservlet/products?action=like&productId=${product.id}`);
//       setLikeCount((prevCount) => prevCount !== "NaN" && prevCount != null ? prevCount + 1 : 1);  // Increment like count safely
//     } catch (error) {
...
//                     </p>
//                     <p>
//                       <strong>Description: </strong> {accessory.description || "No description"}
//                     </p>
//                     <p>
...
//           <span>{likeCount === "NaN" || likeCount === null ? "Likes not available" : `${likeCount} Likes`}</span>
//         </div>
...
//           &nbsp;
//           <div className="xyz">
//           <p className="total-discount">Discount: ${totalDiscount.toFixed(2)}</p>
